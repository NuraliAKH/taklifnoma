...
const getTemplateName = (t: Template) => {
  ...
  if (t.id === 15) return 'Champagne Nude Envelope Web (Сайт)';
  if (t.id === 16) return 'Dusty Rose & Peach Envelope Web (Сайт)';
...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-colors duration-300 selection:bg-amber-500 selection:text-slate-900 relative ${
      ...
      {/* Footer */}
      <footer className={`py-10 border-t text-center text-xs mt-12 z-10 relative backdrop-blur-sm transition-colors duration-300 ${
        isDark ? 'border-white/5 text-slate-400 bg-slate-950/80' : 'border-slate-200 text-slate-600 bg-white/80'
      }`}>
        <div className="flex flex-col items-center justify-center gap-5 max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-4 py-1">
            <a
              href="https://t.me/web_taklifnoma"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-sky-500/10 hover:bg-sky-500/20 border border-sky-500/30 text-sky-400 font-semibold text-xs transition-all hover:scale-105"
            >
            ...
            <a
              href="https://instagram.com/web_taklifnoma"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-pink-500/10 hover:bg-pink-500/20 border border-pink-500/30 text-pink-400 font-semibold text-xs transition-all hover:scale-105"
            >
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
